    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
                    ...
                    ({
                      ...
                      return (
                        <button
                          ...
                          onClick={() => field.onChange(id)}
                          className={cn(
                            "flex flex-col items-start gap-0.5 px-4 py-3 rounded-xl border text-left transition-all duration-150",
                            isSelected
        ...
        <div className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-1.5">
              {PRESET_MATERIALS.filter((m) => !materials.includes(m)).map(
                (m) => (
                  <button
                    key={m}
                    type="button"
      ...
      <section>
        <SectionHeader
          ...
          subtitle="Sube una foto, busca en banco de imágenes o pega una URL"
        />
        <MediaUploader
          value={imageUrl}
