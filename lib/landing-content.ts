...
export const LANDING_DEFAULTS: LandingContent = {
  ...
  hero_subtitle:
    "TenPlanner junta biblioteca, alumnos, grupos, agenda y carga de trabajo en un sistema rapido para entrenadores de deportes de raqueta.",
  hero_cta_primary: "Empezar gratis",
  hero_cta_secondary: "Ver sistema",
  specs_strip: [
    { k: "Planificacion", v: "3 min", sub: "de idea a sesion" },
    { k: "Biblioteca", v: "137+", sub: "drills y clases" },
    { k: "Pista", v: "75 min", sub: "guion por fases" },
    { k: "Historial", v: "1 lugar", sub: "alumnos y carga" },
  ],
  planner_heading: "Planificacion guiada\ncon contexto real.",
  planner_description:
    "Objetivo, nivel, notas y biblioteca quedan ordenados antes de convertir una clase en sesion.",
  biblioteca_heading: "Tu biblioteca de ejercicios\ny clases de raqueta.",
  biblioteca_description:
    "Drills organizados por nivel, golpe, fase, duracion y objetivo. Crea los tuyos, marca favoritos y conviertelos en sesiones completas.",
  anatomia_heading: "La sesion completa,\nordenada por fases.",
  anatomia_description:
    "Cada ejercicio tiene tiempo, intensidad y foco. La carga deja de ser una intuicion perdida en una libreta.",
...
export const LANDING_FIELD_DEFINITIONS: LandingFieldDefinition[] = [
  ...
  },
  {
    ...
    label: "Planificacion - Descripcion",
    group: "Secciones",
    multiline: true,
    maxLength: 360,
  },
