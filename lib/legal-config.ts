export const legal = {
  companyName:
    ...
    "⚠ LEGAL_COMPANY_NAME no configurado",
  nif: process.env.NEXT_PUBLIC_LEGAL_NIF ?? "⚠ LEGAL_NIF no configurado",
  address:
  ...
  dpo: process.env.NEXT_PUBLIC_LEGAL_DPO ?? null,
  mercantileRegistry: process.env.NEXT_PUBLIC_LEGAL_MERCANTILE_REGISTRY ?? null,
};
